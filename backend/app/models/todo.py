...
class Todo(TimestampMixin, Base):
    ...
    original_owner_id: Mapped[str | None] = mapped_column(String(36), nullable=True, index=True)
    target_user_id: Mapped[str | None] = mapped_column(String(36), nullable=True, index=True)
    task_flow_type: Mapped[str] = mapped_column(String(30), nullable=False, default="user_execution")
    last_flow_state: Mapped[str | None] = mapped_column(String(20), nullable=True)
    last_flow_type: Mapped[str | None] = mapped_column(String(30), nullable=True)
